...
Public Class REPORT_DEVOL_IMPR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SICAF.REPORT_DEVOL_IMPR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedREPORT_DEVOL_IMPR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REPORT_DEVOL_IMPR = New REPORT_DEVOL_IMPR()
        rpt.Site = Me.Site
        Return rpt
    End Function
