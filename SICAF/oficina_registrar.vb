Public Class oficina_registrar
    Dim cod, descr, ubi, piso, uni, pat, mat, nom As String

    Private Sub Form2_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Administrador.NuevaOficinaToolStripMenuItem.Enabled = True
    End Sub

    Private Sub oficina_registrar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            filas = Me.OficinaTableAdapter.Insert(cod, descr.ToUpper, ubi, piso, uni, pat, mat, nom)
            If (filas > 0) Then
