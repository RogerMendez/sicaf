...
Public Class REPORTE_REVALUOS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SICAF.REPORTE_REVALUOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedREPORTE_REVALUOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REPORTE_REVALUOS = New REPORTE_REVALUOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
